        ...
        const SVG = () => {
            ...
            const pathLengthsFirst = useTransform(scrollYProgress, [0, 0.5], [0, 1]);
            const pathLengthsSecond = useTransform(scrollYProgress, [0, 0.5], [0, 1]);
            const pathLengthsThird = useTransform(scrollYProgress, [0, 0.5], [0, 1]);
            const pathLengthsFourth = useTransform(scrollYProgress, [0, 0.5], [0, 1]);
            const pathLengthsFifth = useTransform(scrollYProgress, [0, 0.5], [0, 1]);
            
            const pathLengths = [pathLengthsFirst, pathLengthsSecond, pathLengthsThird, pathLengthsFourth, pathLengthsFifth];
            const transition = {
                duration: 0,
                ease: "linear",
            };
